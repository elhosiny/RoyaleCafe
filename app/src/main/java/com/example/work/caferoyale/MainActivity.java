  ...
  /*  @Override
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.order) {
            ...
            startActivity(new Intent(this , Offer.class));

        } else if (id == R.id.settings) {
            startActivity(new Intent(this , Settings_locale.class));
    ...
    public void Register (View view){
        ...
        { Toast toast =Toast.makeText(this,"Not Registered ,, Please Enter Your Name And Phone ", Toast.LENGTH_SHORT);
            toast.show();}
        else
        {
